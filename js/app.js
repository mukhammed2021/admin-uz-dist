            ...
            spollerLabel.addEventListener("click", (() => {
                ...
                Array.from(labels).filter(((label, labelIndex) => {
                    ...
                    label.addEventListener("click", (() => {
                        if (labelIndex !== index) spollerLabel.classList.remove("_active-label");
                    }));
                }));
            }));
        }));
        ...
        try {
            ...
            positions.forEach((position => {
                position.addEventListener("click", (() => {
                    if (position.dataset.value === "admin") document.querySelector("[data-login]").href = "admin-panel.html"; else if (position.dataset.value === "kassir") document.querySelector("[data-login]").href = "kassir-panel.html"; else if (document.querySelector("[data-login]")) document.querySelector("[data-login]").href = "#";
                }));
            }));
        } catch (err) {
